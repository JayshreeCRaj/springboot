...
public class ProductServiceImpl implements IProduct {
	...
	public Product getProductsUsingName(String productName) {
		// TODO Auto-generated method stub
		return productRepository.getProductsUsingName(productName);
		
		/*
		 * var dbProduct= productRepository.findBypName(productName);
		 * log.info("DB Product details {} {} ", dbProduct.getPName(),
		 * dbProduct.getPrice()); return dbProduct;
		 */
	}
	
	public ProductPageResponse getProductsUsingPagination(PageRequest pageRequest) {
		Page<Product> page = productRepository.findAll(pageRequest);
		var products = page.getContent();
		var noOfElements = page.getNumberOfElements();
		var totalPages = page.getTotalPages();
		
		ProductPageResponse response = new ProductPageResponse();
		response.setTotalNoOfElements(noOfElements);
		response.setTotalPageNumer(totalPages);
